...
#define SPI_FRAM_WP_PIN 14

#define SPI_FRAM_HOLD_PORT GPIOB
#define SPI_FRAM_HOLD_PIN 10



#define SPI_FRAM_MODE SPI_MODE0
#define SPI_FRAM_SPEED SPI_BAUDRATEPRESCALER_64
#define FRAM_SIZE 262144UL
//(8 * 32768)
