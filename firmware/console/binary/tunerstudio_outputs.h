...
typedef struct {
	...
	unsigned int enableIgnition : 1; // bit 1
	unsigned int enableInjectors : 1; // bit 2
	...
	uint8_t unusedAtTheEnd[40]; // we have some unused bytes to allow compatible TS changes
