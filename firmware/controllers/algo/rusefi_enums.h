...
typedef enum {
	...
	GP1_LOAD_TPS = 1,
	GP1_LOAD_CLT = 2,
	Force_4bytes_size_gpPwm1Load_e = ENUM_32_BITS,
} gpPwm1Load_e;
typedef enum {
	GP2_LOAD_MAP = 0,
	GP2_LOAD_TPS = 1,
	GP2_LOAD_CLT = 2,
	Force_4bytes_size_gpPwm2Load_e = ENUM_32_BITS,
} gpPwm2Load_e;
typedef enum {
	GP3_LOAD_MAP = 0,
	GP3_LOAD_TPS = 1,
	GP3_LOAD_CLT = 2,
	Force_4bytes_size_gpPwm3Load_e = ENUM_32_BITS,
} gpPwm3Load_e;
typedef enum {
	GP4_LOAD_MAP = 0,
	GP4_LOAD_TPS = 1,
	GP4_LOAD_CLT = 2,
	Force_4bytes_size_gpPwm4Load_e = ENUM_32_BITS,
} gpPwm4Load_e;
